...
if char_output == '?'{
    ...
    io::stdin().read_line(&mut total_input)
            .expect("Failed to read line");
    char_iter = total_input.chars();
...
*/
    ...
    let mut input_detect = String::new();
    ...
    loop {
        ...
        if output.0 > std::u8::MAX as i64 {
            ...
            print!("{}", char_output);
            input_detect += &char_output.to_string();

            if input_detect == "Command?\n".to_string(){
                // println!("THIS SHOULD STOPE");
                total_input = String::new();
                io::stdin().read_line(&mut total_input)
                        .expect("Failed to read line");
                char_iter = total_input.chars();
